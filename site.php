...
use \carcaju\Page;
use \carcaju\Model\Product;
use \carcaju\Model\Category;
use \carcaju\Model\Cart;
use \carcaju\Model\Address;
use \carcaju\Model\User;
use \carcaju\Model\Order;
use \carcaju\Model\OrderStatus;
...
$app->get("/products/:desulr",function($desurl) {
...
$app->post("/register", function(){
	...
	if(User::checkLoginExist($_POST['email'])===true) {
		User::setErrorRegister("Esse email já está sendo usado por outro usuario");
		header("Location: /login");
		exit;
	}
...
$app->post("/profile/change-password",function() {
	...
	if($_POST['new_pass'] != $_POST['new_pass_confirm']) {
		User::setError("A confirmação da senha está diferente");
		header("Location: /profile/change-password");
		exit;
	}
